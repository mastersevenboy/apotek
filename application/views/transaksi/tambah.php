                ...
                <form action="" method="post" class="form-obat">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="kode_obat" class="form-control" id="obat">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tfoot style="display:none">
                                ...
                                <tr><th colspan="6" class="text-center">Jumlah Uang</th>
                                    <th class="jumlah_uang"></th>
                                </tr>
                                <tr><th colspan="6" class="text-center">Jumlah Uang Kembalian</th>
