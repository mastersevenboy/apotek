				...
				<table class="table table-bordered" id="dataTable">
					...
					<tbody>
						<tr>
							...
							<td>
								<a href="<?php echo site_url('supplier/hapus/') . $o->id_sp; ?>" class="btn btn-danger btn-circle btn-sm"><i class="fa fa-trash"></i></a>
								<a href="" data-id="<?php echo $o->id_sp; ?>" class="btn btn-primary btn-circle btn-sm btn-ubah-sup"><i class="fa fa-edit"></i></a>
							</td>
						</tr>
					</tbody>
					<?php endforeach ?>
