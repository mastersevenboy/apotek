...
<head>
    <title>Laporan Penjualan Perminggu</title>
    <meta charset="utf-8">
...
<tr>
    <td colspan="2" style="width:800px;paddin-left:20px;"><center><h4>LAPORAN Penjualan Perminggu</h4></center></td>
</tr>
...
<center><h3>Tabel Laporan Penjualan Perminggu</h3></center>
<?php 
    $subtotal=$jml->row_array();
?>
<table class="demo-table" align="center" style="width:900px;margin-bottom:20px;" border="1">
        <thead>
            <?php foreach($obat->result() as $t) : ?>
            <tr>
                <th colspan="9">Laporan Pada <?php echo $t->minggu; ?></th>
            </tr>
            <?php endforeach ?>
            <tr>
                <th>No</th>
