...
<tr>
    <td colspan="2" style="width:800px;paddin-left:20px;"><center><h4>LAPORAN Penjualan Pertanggal</h4></center></td>
</tr>
...
<center><h3>Tabel Laporan Penjualan Pertanggal</h3></center>
<?php 
    $b=$jml->row_array();
?>
<table class="demo-table" align="center" style="width:900px;margin-bottom:20px;" border="1">
        <thead>
            ...
            <tr>
                <th colspan="9"><?php echo $t->tgl; ?></th>
            </tr>
            <?php endforeach ?>
            <tr>
                <th>No</th>
