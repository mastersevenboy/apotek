...
(39, 34, 'ENTR01', 1),
(40, 35, 'PRCL', 1),
(41, 36, '8993365131538', 1),
(42, 37, '8993365131538', 1),
(43, 38, 'BTDN', 1);
...
INSERT INTO `obat` (`kode`, `supplier_id`, `nama_obat`, `produsen`, `stok`, `foto`, `harga`, `keterangan`, `bar_code`) VALUES
('8993365131538', 4, 'Madu TJ', 'PT Ultra Sakti', 10, '2021-03-19-12-31-52_60538e8852b41.jpg', 15000, 'Baik untuk penyembuhan', '8993365131538.jpg'),
...
(36, '2021-03-19 01:26:24', 'Saras', 1, 15000, 20000, 5000),
(37, '2021-03-19 01:32:18', 'Khasan', 1, 15000, 100000, 85000),
(38, '2021-03-19 01:33:51', 'umi', 1, 10000, 10000, 0);
...
--
ALTER TABLE `detail_transaksi`
  MODIFY `id_dtl` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
